...
store.stapsMemory.stap1_Foundation.stap5.currentIndex = index
store.stapsMemory.stap1_Foundation.stap5.priceValue = item.price_value
...
onMounted(()=>{
    ...
    if(store.stapsMemory.stap1_Foundation.stap5.currentIndex){
        let currentIndexSelect = +store.stapsMemory.stap1_Foundation.stap5.currentIndex
        ...
        store.stapsMemory.stap1_Foundation.stap5.currentIndex = 0
        
        store.stapsMemory.stap1_Foundation.stap5.priceValue = store.dataServer.foundation.stap_5[0].price_value
    }
