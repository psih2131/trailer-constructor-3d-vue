...
const selectCurrentSize = (item, index)=>{
    ...
    store.stapsMemory.stap4_AddOns.stap2.selectedElements = valueStoreArray
...
onMounted(()=>{
    ...
    sizeList.value = store.dataServer['add-ons'].stap_2
    ...
    if(store.stapsMemory.stap4_AddOns.stap2.selectedElements.length > 0){

        let arraySelectedListStore = store.stapsMemory.stap4_AddOns.stap2.selectedElements
        ...
        store.stapsMemory.stap4_AddOns.stap2.selectedElements = []
    }
