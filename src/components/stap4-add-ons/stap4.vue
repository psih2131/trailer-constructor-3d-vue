...
<script setup >
  ...
  const sizeList = ref([
    {
        "title":'43" Exterior TV Menu Display',
        "subtitle":'Weatherproof digital menu board',
        "cost":'+$1,150',
...

    {
        ...
        "subtitle":'Complete custom-designed wrap',
        "cost":'+$4,000',
        "model": trailerModel_7x12,
        "selected": false,
    },
    ...
    {
        "title":'WiFi/Internet System',
        "subtitle":'Router, antenna, cellular backup',
        "cost":'+$650',
        "model": trailerModel_7x12,
        "selected": false,
    },
    {
        "title":'POS System Package',
        "subtitle":'Tablet, printer, cash drawer, and mounting hardware',
        "cost":'+$1,250',
        "model": trailerModel_7x12,
        "selected": false,
    },

    {
        ...
        "subtitle":'Full off-grid capability with panels, batteries, and inverter',
        "cost":'+$8,500',
        "model": trailerModel_7x12,
        "selected": false,
    },
