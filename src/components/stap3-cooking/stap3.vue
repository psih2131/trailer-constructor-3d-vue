...
<script setup >
  ...
  const sizeList = ref([
    {
        "title":'2-Bay Steam Table',
        "subtitle":'Keep sauces and sides perfectly warm',
        "cost":'+$850',
        "model": trailerModel_7x12,
        "selected": false,
    },
    {
        "title":'Insulated Heater/Proofer Cabinet',
        "subtitle":'Hold cooked food or proof dough',
        "cost":'+$1,650',
        "model": trailerModel_7x12,
        "selected": false,
    },
    {
        ...
        "subtitle":'Maintain food at safe serving temperatures',
        "cost":'+$1,250',
        "model": trailerModel_7x12,
        "selected": false,
    },
