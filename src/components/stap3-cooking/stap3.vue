<template>
    <div class="body-main-data__wrapper" v-if="store.dataServer.equipment?.stap_3?.length >0">
...
onMounted(()=>{
    ...
    sizeList.value = store.dataServer.equipment.stap_3
    ...
    if(store.stapsMemory.stap3_Equipment.stap3.selectedElements.length > 0){

        let arraySelectedListStore = store.stapsMemory.stap3_Equipment.stap3.selectedElements
        ...
        store.stapsMemory.stap3_Equipment.stap3.selectedElements = []
    }
