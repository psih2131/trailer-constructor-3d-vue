...
const selectCurrentSize = (item, index)=>{
    ...
    store.stapsMemory.stap3_Equipment.stap4.selectedElements = valueStoreArray
...
onMounted(()=>{
    ...
    if(store.stapsMemory.stap3_Equipment.stap4.selectedElements.length > 0){

        let arraySelectedListStore = store.stapsMemory.stap3_Equipment.stap4.selectedElements
        ...
        store.stapsMemory.stap3_Equipment.stap4.selectedElements = []
    }
