...
const selectCurrentSize = (item, index)=>{
    ...
    store.stapsMemory.stap3_Equipment.stap2.selectedElements = valueStoreArray
...
onMounted(()=>{
    ...
    sizeList.value = store.dataServer.equipment.stap_2
    ...
    if(store.stapsMemory.stap3_Equipment.stap2.selectedElements.length > 0){

        let arraySelectedListStore = store.stapsMemory.stap3_Equipment.stap2.selectedElements
        ...
        store.stapsMemory.stap3_Equipment.stap2.selectedElements = []
    }
