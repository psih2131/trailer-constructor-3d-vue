  ...
  const sizeList = ref([
    {
        ...
        "subtitle":"200W panel, charge controller, battery bank",
        "cost":"+$1,800",
        "model": trailerModel_7x12,
        "selected": false,
    },
    {
        "title":"Standard Solar Package",
        "subtitle":"400W panels, MPPT controller, 4x 100Ah batteries",
        "cost":"+$3,200",
        "model": trailerModel_7x14,
        "selected": false,
    },
    {
        "title":"Premium Solar Package",
        "subtitle":"800W panels, hybrid inverter, lithium battery bank",
        "cost":"+$5,500",
