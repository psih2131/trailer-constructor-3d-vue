...
const selectCurrentSize = (item, index)=>{
    ...
    store.stapsMemory.stap2_Utilities.stap3.selectedElements = valueStoreArray
...
onMounted(()=>{
    ...
    sizeList.value = store.dataServer.utilities.stap_3
    ...
    if(store.stapsMemory.stap2_Utilities.stap3.selectedElements.length > 0){

        let arraySelectedListStore = store.stapsMemory.stap2_Utilities.stap3.selectedElements
        ...
        store.stapsMemory.stap2_Utilities.stap3.selectedElements = []
    }
