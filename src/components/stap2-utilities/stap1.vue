...
onMounted(()=>{
    ...
    if(store.stapsMemory.stap2_Utilities.stap1.selectedElements.length > 0){

        let arraySelectedListStore = store.stapsMemory.stap2_Utilities.stap1.selectedElements
        ...
        store.stapsMemory.stap2_Utilities.stap1.selectedElements = []
    }
