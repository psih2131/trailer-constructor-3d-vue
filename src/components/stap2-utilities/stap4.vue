<template>
    <div class="body-main-data__wrapper" v-if="store.dataServer.utilities?.stap_4?.length >0">
        ...
        <div class="trailer-size">
            ...
            <template v-for="(item,index) in sizeList">
                <div class="trailer-size__choice-element choice-element choice-element--50" 
...
const selectCurrentSize = (item, index)=>{
    ...
    store.stapsMemory.stap2_Utilities.stap4.selectedElements = valueStoreArray
...
onMounted(()=>{
    ...
    sizeList.value = store.dataServer.utilities.stap_4
    ...
    if(store.stapsMemory.stap2_Utilities.stap4.selectedElements.length > 0){

        let arraySelectedListStore = store.stapsMemory.stap2_Utilities.stap4.selectedElements
        ...
        store.stapsMemory.stap2_Utilities.stap4.selectedElements = []
    }
